...
| `fitted/models/*.ts` | Mongo schemas: `User`, `WardrobeItem`, `OutfitInteraction`, `WardrobeImage`, `GenerationSnapshot` (M4b model; **live snapshot write since M5**) |
