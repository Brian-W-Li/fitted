...
Track-2 doc is **`docs/plans/track2-ops-card.md`** (how to watch the collection, pull the M6 export, the
residuals backlog, the Brian-as-friend-#0 script, the onboarding draft). The 2026-07-18 friend-ready
session (`docs/plans/track2-friend-ready-2026-07-18.md`) shifted the acceptance test from "a fresh audit
